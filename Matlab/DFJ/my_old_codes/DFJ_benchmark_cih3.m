...
I           = 0.8;  % income percentile (in the paper, quintiles: 0.2 to 1)
...
figure(3)
plot(v_x, m_c(:, :, 27), v_x, v_x, '--', v_x, c_ubar*ones(N_x,1), '--')
title('consumption')
xlabel('cash-in-hand')

figure(4)
plot(1:T-1, next_med)
title('average med expenses next period (given health status and persistent shock')
xlabel('period t')
