...
c_ubar      = 0; %2663; % consumption floor
age_max     = 100; % max age
...
m_x_prime   = zeros(N_periods * N_health, N_grid);   % end-of-period cash-in-hand
...
for period = N_periods-1:-1:1
    ...
    for h = 1:N_health
       ...
       parfor i = 1:N_grid
            ...
            net_cash    = v_x(i) + y - interp1(brackets, tax, y) ...
                          - med(period, h);
